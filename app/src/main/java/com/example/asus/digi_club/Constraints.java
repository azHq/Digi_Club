...
public class Constraints {
    ...
    public static  final String BASEURL="https://digi-club.000webhostapp.com/azaz/";
    public static  final String SIGNUPURL=BASEURL+"signup.php";
    public static  final String SIGNINURL=BASEURL+"sign_in.php";
    ...
    public static  final String UPDATE_FOOD_ITEM=BASEURL+"UpdateFoodItem.php";
