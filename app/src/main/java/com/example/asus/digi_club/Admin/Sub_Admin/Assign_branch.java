...
public class Assign_branch extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog=new ProgressDialog(Assign_branch.this);
        ...
        public void onBindViewHolder(@NonNull RecycleAdapter.ViewAdapter holder, final int position) {
            ...
            holder.checkBox1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    All_Sub_Admin.branch_id=memberInfo[0].id;
                    finish();
                }
            });
            ...
            if(memberInfo[1]!=null){
                ...
                holder.checkBox2.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        All_Sub_Admin.branch_id=memberInfo[1].id;
                        finish();
                    }
                });
            }
